...
export default function HistoryLeaders() {
  ...
  return (
    <section className="py-24 lg:py-40 bg-background-dark relative overflow-hidden" id="history-leaders">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
              Jejak <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-primary via-purple-400 to-accent">Kepemimpinan</span>
            </h2>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {leaders.map((leader) => (
            ...
            >
              {/* Decorative Glow */}
              <div className={`absolute -inset-2 bg-linear-to-br ${leader.color} rounded-[3rem] blur-2xl opacity-0 group-hover:opacity-15 transition-opacity duration-700`}></div>
              ...
              <div className="relative h-full glass-card rounded-[2.5rem] border-white/5 group-hover:border-white/20 transition-all duration-500 overflow-hidden bg-slate-900/20">
                ...
                <div className="absolute top-4 right-4 z-20">
                  <div className={`w-8 h-8 rounded-full bg-linear-to-br ${leader.color} flex items-center justify-center p-0.5 shadow-lg shadow-black/50`}>
                ...
                <div className="p-6 pt-4 space-y-4">
                  ...
                  <div className="flex items-center justify-center gap-4 pt-2">
                    {leader.socials.instagram && (
                      <a href={leader.socials.instagram} className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-slate-500 hover:text-white hover:bg-white/10 transition-all border border-white/5">
                        <FaInstagram className="text-sm" />
                      </a>
                    )}
                    {leader.socials.linkedin && (
                      <a href={leader.socials.linkedin} className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-slate-500 hover:text-white hover:bg-white/10 transition-all border border-white/5">
                        <FaLinkedin className="text-sm" />
                      </a>
                    )}
                    {leader.socials.github && (
                      <a href={leader.socials.github} className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-slate-500 hover:text-white hover:bg-white/10 transition-all border border-white/5">
