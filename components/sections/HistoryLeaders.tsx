      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          ...
          <p className="text-slate-400 max-w-sm font-medium text-lg border-l-2 border-primary/30 pl-6">
            Para pemimpin yang telah membimbing iTech Poliban bertumbuh dan
            berinovasi dari masa ke masa.
          </p>
        </div>
                ...
                <div className="p-6 pt-4 space-y-4">
                  <div className="text-center">
                    ...
                    <div className="inline-flex items-center gap-2 mt-2">
                      <div
                        className={`h-px w-3 bg-linear-to-r ${leader.color}`}
                      ></div>
                      <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
                        {leader.role}
                      </p>
                      <div
                        className={`h-px w-3 bg-linear-to-l ${leader.color}`}
                      ></div>
                    </div>
                  </div>
          ...
          <div className="bg-slate-900/60 backdrop-blur-2xl rounded-[2.9rem] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-slate-400 font-medium max-w-xl">
                Kami selalu membuka kesempatan bagi mahasiswa Poliban yang ingin
                berkontribusi dan berkembang bersama di iTech.
              </p>
            </div>
            <button
              type="button"
