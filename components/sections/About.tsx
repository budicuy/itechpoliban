          ...
          <div className="relative">
            <div className="relative z-10 bg-slate-50 dark:bg-white/5 rounded-[2.5rem] p-8 sm:p-12 border border-slate-200 dark:border-white/10 shadow-2xl">
              ...
              <div className="absolute -bottom-6 -right-6 bg-primary text-white p-6 rounded-3xl shadow-xl hidden sm:block">
                ...
                <p className="text-[10px] uppercase font-bold tracking-widest opacity-80">Founded Year</p>
              </div>
            </div>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              <div className="inline-flex items-center px-3 py-1 bg-accent/10 border border-accent/20 rounded-lg">
                <span className="text-[10px] font-black uppercase tracking-widest text-accent">About the Community</span>
              </div>
              <h2 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white leading-[1.1] tracking-tighter">
                Accelerating <span className="text-primary">Digital</span> Innovation.
              </h2>
            </div>

            <div className="space-y-6">
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                iTech Poliban merupakan salah satu komunitas yang ada di Politeknik Negeri Banjarmasin. 
                Didirikan pada tanggal <span className="text-slate-900 dark:text-white font-bold">8 Oktober 2021</span> dan 
                diresmikan pada <span className="text-slate-900 dark:text-white font-bold">25 Februari 2022</span>.
              </p>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Kami adalah wadah bagi mahasiswa yang memiliki passion dengan dunia IT untuk belajar dan berkembang bersama. 
                iTech Poliban terbuka untuk semua prodi dan latar belakang, asalkan memiliki niat dan kemauan untuk belajar.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { title: "Skill Development", desc: "Hardskill & Softskill focus" },
                ...
                <div key={item.title} className="flex gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10">
