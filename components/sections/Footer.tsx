     ...
     <div className="lg:col-span-5 space-y-8">
      <div className="flex items-center gap-4">
       ...
       <div>
        ...
        <p className="text-[10px] text-primary font-bold uppercase tracking-[0.3em] mt-1">Technology Community</p>
       </div>
      </div>

      <p className="text-slate-400 text-lg font-medium leading-relaxed max-w-md">
       Membangun ekosistem teknologi yang inklusif dan inovatif untuk melahirkan talenta digital terbaik dari Politeknik
       Negeri Banjarmasin.
      </p>
