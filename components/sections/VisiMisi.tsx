   ...
   <div className="max-w-7xl mx-auto px-6 relative z-10">
    <div className="text-center mb-20 space-y-4">
     <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-accent/10 border border-accent/20 text-accent">
      ...
      <span className="text-[10px] font-black uppercase tracking-[0.2em]">Goal & Objectives</span>
     </div>
     <h2 className="text-4xl md:text-5xl font-black text-white px-2">
      Visi & <span className="text-transparent bg-clip-text bg-linear-to-r from-accent to-yellow-200">Misi</span>{" "}
      Komunitas
     </h2>
    </div>
      ...
      <div className="relative h-full glass-card p-10 lg:p-12 rounded-[2.5rem] border-white/5 flex flex-col justify-between overflow-hidden">
       ...
       <div>
        ...
        <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed font-medium italic">
         “Meningkatkan Insan <span className="text-primary not-italic font-black">kreatif</span>,{" "}
         <span className="text-primary not-italic font-black">Komunikatif</span>, dan{" "}
         <span className="text-primary not-italic font-black">Religius</span> sehingga dapat berkompetensi dan
         berkompetisi nasional dan internasional dibidang IT"
        </p>
       </div>
      ...
      <div className="flex-1 glass-card p-10 lg:p-12 rounded-[2.5rem] border-white/5 relative overflow-hidden flex flex-col justify-center">
       ...
       <div className="space-y-8 relative z-10">
        ...
        <div
         ...
         <h4 className="text-2xl md:text-3xl font-black text-white mb-4">{misiData[activeMisi].title}</h4>
         <p className="text-lg md:text-xl text-slate-400 font-medium leading-relaxed">{misiData[activeMisi].text}</p>
        </div>
